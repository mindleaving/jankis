    ...
    public static class TypescriptGeneratorRunner
    {
        public static void Run()
        {
            ...
            TypescriptGenerator.TypescriptGenerator.Builder
                ...
                .Exclude<HealthSharingPortal.API.Models.Subscriptions.NotificationType>()
                .Exclude<HealthSharingPortal.API.Models.Subscriptions.PatientEventNotification>()
                .Exclude<HealthSharingPortal.API.Models.Subscriptions.PatientSubscription>()
                .Exclude<HealthSharingPortal.API.Models.Subscriptions.SubscriptionObjectType>()
