        ...
        <>
            ...
            <Accordion defaultActiveKey="-1">
                <AccordionCard 
                    className="mt-2"
                    eventKey="icd11"
                    title={<b>Über den ICD-11 und LOINC</b>}
                >
                    <b>ICD-11</b>
                    <p>
                ...
                <AccordionCard 
                    className="mt-2"
                    eventKey="incidence"
                    title={<b>Inzidenz, Prävalenz und Mortalität</b>}
                >
                    <p>
                ...
                <AccordionCard 
                    className="mt-2"
                    eventKey="symptoms"
                    title={<b>Symptome und Observationen</b>}
                >
                    <ul style={{ listStyleType: 'none' }}>
                ...
                <AccordionCard 
                    className="mt-2"
                    eventKey="bodyStructure"
                    title={<b>Körperstrukturen</b>}
                >
                    <p>
                ...
                <AccordionCard
                    className="mt-2"
                    eventKey="infectious"
                    title={<b>Infektionskrankheiten</b>}
                >
                    <p>
                ...
                <AccordionCard
                    className="mt-2"
                    eventKey="login"
                    title={<b>Die Sperrfunktion und das Login-System</b>}
                >
                    <LoginInfo />
                </AccordionCard>
            </Accordion>
