...
export namespace Models {
    ...
    interface Feedback extends Models.IId {
        createdTimestamp?: Date;
        url: string;
        message: string;
    }

    interface Patient extends Models.IId {
        symptoms: Models.Symptoms.Symptom[];
        observations: Models.Observations.Observation[];
    }

    interface User extends Models.IId {
        username: string;
    }
    ...
    export namespace SignalRClients {
        interface IDiseaseLockClient {
    ...
    export namespace Filters {
        interface DiseaseFilter {
            searchText?: string;
            hasIncidenceData?: boolean | null;
            hasPrevalenceData?: boolean | null;
            hasMortalityData?: boolean | null;
            hasSymptoms?: boolean | null;
            hasObservations?: boolean | null;
            hasDiagnosticCriteria?: boolean | null;
            hasAffectedBodyStructures?: boolean | null;
            isInfectiousDisease?: boolean | null;
            hasDiseaseHosts?: boolean | null;
            hasPathogens?: boolean | null;
        }
    }
}
