...
export const App = (props: AppProps) => {
    ...
    const routes: Route[] = [
        ...
        { path: '/healthrecord/:personId/edit/document/:id', element: <CreatePatientDocumentPage />, audience: [ AccountType.Sharer, AccountType.HealthProfessional, AccountType.EmergencyGuest, AccountType.Researcher ]},
        ...
        { path: '/healthrecord/:personId/edit/note/:id', element: <CreatePatientNotePage />, audience: [ AccountType.Sharer, AccountType.HealthProfessional, AccountType.EmergencyGuest, AccountType.Researcher ]},
