...
interface ImmunizationDrugAutocompleteProps {
    isLoading?: boolean;
...
export const ImmunizationDrugAutocomplete = (props: ImmunizationDrugAutocompleteProps) => {

    const drugAutocompleteRunner = useMemo(() => new AutocompleteRunner<Models.Medication.Drug>('api/drugs/immunizations', 'searchText', 10), []);
