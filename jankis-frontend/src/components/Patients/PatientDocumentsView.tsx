...
export const PatientDocumentsView = (props: PatientDocumentsViewProps) => {
    ...
    return (<div className="mt-3">
        ...
        {props.documents.sort((a,b) => compareDesc(a.timestamp, b.timestamp)).map(document => (
            <PatientDocumentView document={document} />
        ))}
    </div>);
    ...
    return (<Alert variant="secondary">
        <Row>
            <Col xs="auto" className="align-self-center">
                <a 
                    href={apiClient.buildUrl(`api/documents/${props.document.id}/download`, {})} 
                    download
                >
