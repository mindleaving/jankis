                ...
                <Col lg={6}>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Button className="m-1" onClick={() => history.push(`/patients/${id}/nursing`)}>{resolveText('Action_AddEquipment')}</Button>
                            ...
                            <Button className="m-1" onClick={() => history.push(`/patients/${id}/nursing`)}>{resolveText('Action_Nursing')}</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
