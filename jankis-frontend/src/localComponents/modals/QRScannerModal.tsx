...
export const QRScannerModal = (props: QRScannerModalProps) => {
    ...
    const qrCodeTypeButtons = (
        <>
            ...
            <Row>
                <Col className="text-center">
                    <Button size="lg" className="m-2" onClick={() => setQRCodeType(QRCodeType.Patient)}>{resolveText('QRCodeType_Patient')}</Button>
                </Col>
            </Row>
            <Row>
                <Col className="text-center">
                    <Button size="lg" className="m-2" onClick={() => setQRCodeType(QRCodeType.Medication)}>{resolveText('QRCodeType_Medication')}</Button>
                </Col>
            </Row>
            <Row>
                <Col className="text-center">
                    <Button size="lg" className="m-2" onClick={() => setQRCodeType(QRCodeType.Resource)}>{resolveText('QRCodeType_Resource')}</Button>
                </Col>
            </Row>
        </>
    );
